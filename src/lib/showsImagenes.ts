...
export async function subirImagenShow(archivo: File): Promise<{ url?: string; error?: string }> {
...
export async function eliminarImagenShow(url: string): Promise<{ error?: string }> {
